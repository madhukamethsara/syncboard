...
export default function Sidebar({ activeView, gotoApp }) {
  ...
  return (
    <aside className="sidebar">
      ...
      <div className="sidebar-bottom">
        <div className="side-user" onClick={() => gotoApp('profile')}>
          <div className="avatar" style={{ background: currentUser.color, position: 'relative' }}>
            {currentUser.initials}
          </div>
          <div>
            <div className="u-name">{currentUser.name}</div>
            <div className="u-role">View profile</div>
          </div>
        </div>
      </div>
    </aside>
